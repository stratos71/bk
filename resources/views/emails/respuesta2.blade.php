													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-top:20px;width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="left" style="line-height:10px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/920061_904421/cropped-autobo_napa_Vlogo.png" style="display: block; height: auto; border: 0; width: 186px; max-width: 100%;" width="186" alt="Image" title="Image"></div>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:20px;">
																<div style="font-family: 'Times New Roman', Georgia, serif">
																	<div class style="font-size: 12px; font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; mso-line-height-alt: 24px; color: #555555; line-height: 2;">
																		<p style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 28px; letter-spacing: normal;"><em>{{date("d-m-Y")}}</em></p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																	...
																	<img src="https://i.gifer.com/7efs.gif" style="display: block; height: auto; border: 0; width: 250px; max-width: 100%;" width="250" alt="Image" title="Image">
															...
															<td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #000000; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif;">
																		<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="font-size:18px;"><strong>Estimado {{$cotizacion->nombre}}</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad" style="padding-bottom:25px;padding-left:10px;padding-right:10px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #71777D; line-height: 1.2;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:16px;color:#000000;">Su pedido con codigo {{$cotizacion->codigo}} ya esta en nuestro pais.</span></p>
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:16px;color:#000000;">Por favor dirijase a nuestra agencia ubicada en la Avenida Hernan Siles Suazo Nro 20 en horario de oficina, lo estaremos esperando</span></p>
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:16px;color:#000000;">Gracias por contactarnos.</span></p>
